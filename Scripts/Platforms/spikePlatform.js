class SpikePlatform extends Platform{
    ...
    update(time, delta){
        ...
        if(this.spikeL){
            this.spikeL.body.position.x = this.platform.body.position.x + this.spikeL.body.offset.x;
            this.spikeL.body.position.y = this.platform.body.position.y + this.spikeL.body.offset.y;
            this.spikeL.body.velocity.x = this.platform.body.velocity.x;
            this.spikeL.body.velocity.y = this.platform.body.velocity.y;
        }
        if(this.spikeR){
            this.spikeR.body.position.x = this.platform.body.position.x + this.spikeR.body.offset.x;
            this.spikeR.body.position.y = this.platform.body.position.y + this.spikeR.body.offset.y;
    ...
    create(){
        switch(this.imgName){
            ...
            case "spike1LR":
                this.platform.body.setSize(70,this.platform.body.height*0.6);
                break;
            case "spike1L":
                this.platform.body.setSize(90,this.platform.body.height*0.65);
                this.platform.body.offset.x = 170;
                break;
            case "spike1R":
                this.platform.body.setSize(90,this.platform.body.height*0.65);
                this.platform.body.offset.x = 80;
                break;

            case "spike2LR":
                this.platform.body.setSize(60,this.platform.body.height*0.75);
                break;
            case "spike2L":
                this.platform.body.setSize(60,this.platform.body.height*0.7);
                this.platform.body.offset.x = 140;
                break;
            case "spike2R":
                this.platform.body.setSize(60,this.platform.body.height*0.7);
                this.platform.body.offset.x = 80;
        ...
        if(this.imgName.includes("B")){
            ...
            this.spikeB.body.setAllowGravity(false);
            this.spikeB.body.setImmovable(true);
